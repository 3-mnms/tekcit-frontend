    ...
    <section className={styles.container}>
      ...
      <div className={styles.card}>
        ...
        <div className={styles.block}>
          ...
          <FormInput placeholder="기본 주소" value={address} className={styles.address} disabled />
          <FormInput
            placeholder="상세 주소"
            className={styles.input}
            value={addressDetail}
        ...
        <div className={styles.actionRow}>
          <Button className={styles.primaryBtn} onClick={handleSubmit} disabled={addMut.isPending}>
