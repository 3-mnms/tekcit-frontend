        ...
        <div className="form-left">
          ...
          <div className="phone-inputs">
            <div className="phone-box">
              ...
              <div className="error-space">{errors.phonePrefix && <p className="error">{errors.phonePrefix.message}</p>}</div>
            </div>
            <div className="phone-box phone-part1">
              <input type="text" maxLength={4} {...register("phonePart1" as const)} />
              <div className="error-space">{errors.phonePart1 && <p className="error">{errors.phonePart1.message}</p>}</div>
            </div>
            <div className="phone-box phone-part2">
              <input type="text" maxLength={4} {...register("phonePart2" as const)} />
              <div className="error-space">{errors.phonePart2 && <p className="error">{errors.phonePart2.message}</p>}</div>
            </div>
          </div>
        </div>
